...
export interface Preference {
  readonly typ: | 'prefvegan' | 'prefmineraloilfree' | 'prefparabenfree' | 'prefworksforoilyskin' | 'prefcrueltyfree';
  readonly icon?: Icon;
}
...
} /* Additional interfaces and types from transcribed snippets */
...
export interface AnalysisResult {
  ...
  rewritten_query?: string | null; selected_api?: string | null;
  response?: string | null; order_status?: string | null;
  ...
  image?: string | null;
} /* Example additional shape referenced in snippets (orderDetails etc.) */
export interface OrderDetails {
  user_id?: string; credit_card?: string;
  ...
  status?: string;
  nonce?: number;
} /* If you need a combined container type (from snippets that included many optional fields) */
